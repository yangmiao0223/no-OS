...
int32_t adi_initpinmux(void) {
    ...
    *((volatile uint32_t *)REG_GPIO1_CFG) = TIMER1_TIMER1_OUT_PORTP1_MUX | ADC0_IN_ADC_CONVERT_PORTP1_MUX;
    *((volatile uint32_t *)REG_GPIO2_CFG) = TIMER2_TIMER2_OUT_PORTP2_MUX | ADC0_IN_ADC0_IN0_PORTP2_MUX
     | ADC0_IN_ADC0_IN1_PORTP2_MUX | ADC0_IN_ADC0_IN2_PORTP2_MUX | ADC0_IN_ADC0_IN3_PORTP2_MUX
     | ADC0_IN_ADC0_IN4_PORTP2_MUX | ADC0_IN_ADC0_IN5_PORTP2_MUX | ADC0_IN_ADC0_IN6_PORTP2_MUX
